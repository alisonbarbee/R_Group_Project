...
aus_fires <- st_as_sf(aus_fires, coords = c("latitude", "longitude")) %>%
  st_set_crs()
...
ggplot() + 
  geom_sf(data = oz_states) + 
  geom_point(data = aus_fires, mapping = aes(x = lon, y = lat), colour = "red") + 
  coord_sf()


  geom_sf(data = aus_fires, mapping = aes(color = "blue", 
                                          fill = "cyan", 
                                          stat = "sf"))
